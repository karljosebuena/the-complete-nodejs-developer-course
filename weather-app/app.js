...
const main = async () => {
    const country = 'India'
    const mapboxUrl = `https://api.mapbox.com/geocoding/v5/mapbox.places/${country}.json?access_token=pk.eyJ1Ijoia2FybGpvc2VidWVuYSIsImEiOiJjazlrbTI1MWIwMGw4M2RuNW1kZXFxbjVjIn0.Zghwkkgcn4bQ5J2Sm2L7ag`;
